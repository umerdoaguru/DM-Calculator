...
export default function ServicesLanding() {
    ...
    },
 {
  ...
  description:
    "Easily configure percentage and amount-based discount limits for quotations and offers.",
  icon: PercentDiamond, // you can import from lucide-react
  gradient: "from-yellow-600 to-indigo-700",
  bgPattern: "bg-gradient-to-br from-yellow-50 to-indigo-50",
  navigation: "/admin/discount-setting",
  features: [
    "Set percentage-based discounts",
    "Set amount-based discounts",
    "Edit or delete discounts easily",
    "Apply discounts dynamically in quotations",
  ],
}
