...
const NoteSection = () => {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-wrap gap-3 items-center flex-cloumn justify-center bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 text-white p-6">
